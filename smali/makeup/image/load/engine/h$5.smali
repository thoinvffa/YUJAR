.class Lmakeup/image/load/engine/h$5;
...
.method public a(ZLmakeup/image/load/DataSource;Lmakeup/image/load/EncodeStrategy;)Z
    ...
    sget-object p1, Lmakeup/image/load/DataSource;->DATA_DISK_CACHE:Lmakeup/image/load/DataSource;

    if-eq p2, p1, :cond_1

    :cond_0
    sget-object p1, Lmakeup/image/load/DataSource;->LOCAL:Lmakeup/image/load/DataSource;
