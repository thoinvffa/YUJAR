.class public final Lmakeup/image/load/resource/b/a;
...
.method public static a(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p0, p1, p2}, Lmakeup/image/load/resource/b/a;->a(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method public static a(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1, p2, v0}, Lmakeup/image/load/resource/b/a;->a(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private static a(Landroid/content/Context;Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    sget-boolean v0, Lmakeup/image/load/resource/b/a;->a:Z

    if-eqz v0, :cond_1

    invoke-static {p1, p2, p3}, Lmakeup/image/load/resource/b/a;->b(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    sput-boolean p0, Lmakeup/image/load/resource/b/a;->a:Z
    ...
    :goto_1
    invoke-static {p1, p2, p3}, Lmakeup/image/load/resource/b/a;->c(Landroid/content/Context;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
