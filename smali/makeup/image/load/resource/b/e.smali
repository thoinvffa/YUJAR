.class public Lmakeup/image/load/resource/b/e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lmakeup/image/load/resource/b/e;->a:Landroid/content/Context;
...
.method private a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p1, p2}, Lmakeup/image/load/resource/b/e;->b(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-direct {p0, p2}, Lmakeup/image/load/resource/b/e;->a(Landroid/net/Uri;)I
...
.method private a(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lmakeup/image/load/resource/b/e;->a:Landroid/content/Context;
    ...
    iget-object p1, p0, Lmakeup/image/load/resource/b/e;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lmakeup/image/load/resource/b/e;->a:Landroid/content/Context;
...
.method public a(Landroid/net/Uri;IILmakeup/image/load/e;)Lmakeup/image/load/engine/s;
    ...
    invoke-direct {p0, p1, p2}, Lmakeup/image/load/resource/b/e;->a(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lmakeup/image/load/resource/b/e;->a(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lmakeup/image/load/resource/b/e;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lmakeup/image/load/resource/b/a;->a(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public bridge synthetic a(Ljava/lang/Object;IILmakeup/image/load/e;)Lmakeup/image/load/engine/s;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lmakeup/image/load/resource/b/e;->a(Landroid/net/Uri;IILmakeup/image/load/e;)Lmakeup/image/load/engine/s;
...
.method public bridge synthetic a(Ljava/lang/Object;Lmakeup/image/load/e;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lmakeup/image/load/resource/b/e;->a(Landroid/net/Uri;Lmakeup/image/load/e;)Z
