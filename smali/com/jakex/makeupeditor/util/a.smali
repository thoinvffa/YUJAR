.class public Lcom/jakex/makeupeditor/util/a;
...
.method public static a(Lcom/jakex/makeupcore/bean/RecentMakeupConcrete;)V
    ...
    :cond_1
    invoke-static {p0}, Lcom/jakex/makeupeditor/a/a/c;->b(Lcom/jakex/makeupcore/bean/RecentMakeupConcrete;)V
    ...
    invoke-direct {v1, p0}, Lcom/jakex/makeupeditor/material/a/i;-><init>(Lcom/jakex/makeupcore/bean/RecentMakeupConcrete;)V
...
.method public static a(Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;Ljava/util/List;)V
    .locals 7
    ...
    invoke-static {v0}, Lcom/jakex/makeupeditor/util/a;->a(Lcom/jakex/makeupcore/bean/ThemeMakeupMaterial;)V

    goto :goto_0

    :cond_2
    :goto_1
    invoke-virtual {p0}, Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;->getThemeMakeupConcreteConfigList()Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;->setIsFavorite(Z)V
    ...
    :goto_3
    invoke-virtual {p0, v0}, Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;->setDeleteFlag(Z)V

    invoke-static {p0}, Lcom/jakex/makeupeditor/a/a/f;->a(Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;)V
    ...
    invoke-direct {v3, p0}, Lcom/tbuonomo/viewpagerdotsindicator/event/ThemeConcreteEvent;-><init>(Lcom/jakex/makeupcore/bean/ThemeMakeupConcrete;)V
    ...
    invoke-static {v2, v3}, Lcom/jakex/makeupeditor/a/a/d;->a(J)Lcom/jakex/makeupcore/bean/ThemeMakeupCategory;

    move-result-object v2

    if-eqz v2, :cond_9

    invoke-virtual {v2}, Lcom/jakex/makeupcore/bean/ThemeMakeupCategory;->getType()Lcom/jakex/makeupcore/bean/ThemeMakeupCategory$Type;
    ...
    invoke-virtual {v2, v1}, Lcom/jakex/makeupcore/bean/ThemeMakeupCategory;->setIsDownloaded(Z)V

    invoke-static {v2}, Lcom/jakex/makeupeditor/a/a/d;->b(Lcom/jakex/makeupcore/bean/ThemeMakeupCategory;)V
...
.method public static a(Lcom/jakex/makeupcore/bean/ThemeMakeupMaterial;)V
    ...
    invoke-static {p0}, Lcom/jakex/makeupeditor/a/a/g;->b(Lcom/jakex/makeupcore/bean/ThemeMakeupMaterial;)V
    ...
    invoke-direct {v1, p0}, Lcom/jakex/makeupeditor/material/a/g;-><init>(Lcom/jakex/makeupcore/bean/ThemeMakeupMaterial;)V
