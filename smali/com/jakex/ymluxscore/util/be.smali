.class public Lcom/jakex/ymluxscore/util/be;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/jakex/ymluxscore/util/be$a;
    }
.end annotation
...
.field private c:Lcom/jakex/ymluxscore/dialog/CommonAlertDialog;

.field private d:Lcom/jakex/ymluxscore/util/be$a;


# direct methods
.method public constructor <init>(Landroidx/fragment/app/Fragment;Lcom/jakex/ymluxscore/util/be$a;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/jakex/ymluxscore/util/be;->b:Landroidx/fragment/app/Fragment;

    invoke-virtual {p1}, Landroidx/fragment/app/Fragment;->getActivity()Landroidx/fragment/app/FragmentActivity;

    move-result-object p1

    iput-object p1, p0, Lcom/jakex/ymluxscore/util/be;->a:Landroid/app/Activity;

    iput-object p2, p0, Lcom/jakex/ymluxscore/util/be;->d:Lcom/jakex/ymluxscore/util/be$a;

    return-void
.end method

.method static synthetic a(Lcom/jakex/ymluxscore/util/be;)Landroid/app/Activity;
    .locals 0

    iget-object p0, p0, Lcom/jakex/ymluxscore/util/be;->a:Landroid/app/Activity;
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/jakex/ymluxscore/util/be;->d:Lcom/jakex/ymluxscore/util/be$a;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Lcom/jakex/ymluxscore/util/be$a;->a()V
    ...
    iget-object v0, p0, Lcom/jakex/ymluxscore/util/be;->a:Landroid/app/Activity;
    ...
    invoke-virtual {p0}, Lcom/jakex/ymluxscore/util/be;->b()V

    return-void

    :cond_3
    iget-object v0, p0, Lcom/jakex/ymluxscore/util/be;->b:Landroidx/fragment/app/Fragment;
...
.method public a(I[Ljava/lang/String;[I)V
    ...
    iget-object p1, p0, Lcom/jakex/ymluxscore/util/be;->d:Lcom/jakex/ymluxscore/util/be$a;

    if-eqz p1, :cond_1

    invoke-interface {p1}, Lcom/jakex/ymluxscore/util/be$a;->a()V
...
.method public b()V
    ...
    iget-object v0, p0, Lcom/jakex/ymluxscore/util/be;->c:Lcom/jakex/ymluxscore/dialog/CommonAlertDialog;

    if-nez v0, :cond_0

    new-instance v0, Lcom/jakex/ymluxscore/dialog/CommonAlertDialog$a;

    iget-object v1, p0, Lcom/jakex/ymluxscore/util/be;->a:Landroid/app/Activity;
    ...
    new-instance v2, Lcom/jakex/ymluxscore/util/be$1;

    invoke-direct {v2, p0}, Lcom/jakex/ymluxscore/util/be$1;-><init>(Lcom/jakex/ymluxscore/util/be;)V
    ...
    iput-object v0, p0, Lcom/jakex/ymluxscore/util/be;->c:Lcom/jakex/ymluxscore/dialog/CommonAlertDialog;

    new-instance v1, Lcom/jakex/ymluxscore/util/be$2;

    invoke-direct {v1, p0}, Lcom/jakex/ymluxscore/util/be$2;-><init>(Lcom/jakex/ymluxscore/util/be;)V
