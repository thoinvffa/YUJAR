.class public Lcom/jakex/makeupsenior/makeup/i;
...
.method public a(Lcom/jakex/makeup/library/arcorekit/edit/ar/b;Lcom/jakex/makeup/library/arcorekit/edit/ar/d;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/jakex/makeupsenior/makeup/i;->h:Lcom/jakex/makeup/library/arcorekit/edit/ar/plistdata/i;
    ...
    :cond_1
    iget-boolean p2, p0, Lcom/jakex/makeupsenior/makeup/i;->f:Z
    ...
    iget-wide v1, p0, Lcom/jakex/makeupsenior/makeup/i;->b:J
    ...
    :goto_0
    iget-boolean p2, p0, Lcom/jakex/makeupsenior/makeup/i;->d:Z
    ...
    iget v0, p0, Lcom/jakex/makeupsenior/makeup/i;->a:I
    ...
    :cond_3
    iget-object p2, p0, Lcom/jakex/makeupsenior/makeup/i;->h:Lcom/jakex/makeup/library/arcorekit/edit/ar/plistdata/i;
...
.method public e()Lcom/jakex/makeupeditor/a/a;
    ...
    iput-wide v3, p0, Lcom/jakex/makeupsenior/makeup/i;->b:J

    iget-wide v3, p0, Lcom/jakex/makeupsenior/makeup/i;->b:J
    ...
    iput-wide v1, p0, Lcom/jakex/makeupsenior/makeup/i;->b:J

    :cond_0
    iget-boolean v1, p0, Lcom/jakex/makeupsenior/makeup/i;->d:Z
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/jakex/makeupsenior/makeup/i;->f()V

    invoke-static {}, Lcom/jakex/makeupsenior/model/b;->a()Lcom/jakex/makeupsenior/model/b;

    move-result-object v1

    iget-wide v2, p0, Lcom/jakex/makeupsenior/makeup/i;->b:J

    invoke-virtual {v1, v2, v3}, Lcom/jakex/makeupsenior/model/b;->c(J)I

    move-result v1

    iput v1, p0, Lcom/jakex/makeupsenior/makeup/i;->g:I
    ...
    invoke-virtual {p0, v1}, Lcom/jakex/makeupsenior/makeup/i;->a(Lcom/jakex/makeupeditor/configuration/PartPosition;)Lcom/jakex/makeup/library/arcorekit/edit/ar/plistdata/i;

    move-result-object v1

    iput-object v1, p0, Lcom/jakex/makeupsenior/makeup/i;->h:Lcom/jakex/makeup/library/arcorekit/edit/ar/plistdata/i;

    iget v1, p0, Lcom/jakex/makeupsenior/makeup/i;->g:I

    const/4 v2, -0x1

    if-ne v1, v2, :cond_2

    iget-object v1, p0, Lcom/jakex/makeupsenior/makeup/i;->h:Lcom/jakex/makeup/library/arcorekit/edit/ar/plistdata/i;
    ...
    iget v4, p0, Lcom/jakex/makeupsenior/makeup/i;->g:I
    ...
    iget v2, p0, Lcom/jakex/makeupsenior/makeup/i;->g:I
