...
# virtual methods
.method public onEvent(Lcom/jakex/makeupcore/modular/b/e;)V
    .locals 2
    ...
    invoke-static {p1}, Lcom/jakex/makeupcore/modular/a/a;->e(Z)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/jakex/makeup/api/c;->a(FLcom/jakex/makeupcore/net/j;)V

    return-void
.end method

.method public onEventMainThread(Lcom/jakex/makeupcore/bean/Chat;)V
    .locals 5
    .annotation runtime Lorg/greenrobot/eventbus/Subscribe;
        threadMode = .enum Lorg/greenrobot/eventbus/ThreadMode;->MAIN:Lorg/greenrobot/eventbus/ThreadMode;
    .end annotation

    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getUploadState()Ljava/lang/Integer;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/jakex/makeupcore/util/bj;->a(Ljava/lang/Integer;I)I
    ...
    invoke-direct {v1, p0, p1}, Lcom/jakex/makeup/setting/feedback/FeedbackActivity$b$1;-><init>(Lcom/jakex/makeup/setting/feedback/FeedbackActivity$b;Lcom/jakex/makeupcore/bean/Chat;)V
    ...
    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getChatFail()Ljava/lang/Boolean;

    move-result-object v0

    invoke-static {v0, v1}, Lcom/jakex/makeupcore/util/bj;->a(Ljava/lang/Boolean;Z)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getContent()Ljava/lang/String;
    ...
    invoke-static {v4, v1, v0}, Lcom/jakex/makeup/setting/feedback/FeedbackActivity;->a(Lcom/jakex/makeup/setting/feedback/FeedbackActivity;Ljava/lang/String;Z)Lcom/jakex/makeupcore/bean/Chat;
    ...
    invoke-virtual {v0, p1}, Lcom/jakex/makeupcore/bean/Chat;->setChatFail(Ljava/lang/Boolean;)V

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/jakex/makeupcore/bean/Chat;->setUploadState(Ljava/lang/Integer;)V
    ...
    invoke-static {v4, v2, v0}, Lcom/jakex/makeup/setting/feedback/FeedbackActivity;->a(Lcom/jakex/makeup/setting/feedback/FeedbackActivity;Ljava/lang/String;Z)Lcom/jakex/makeupcore/bean/Chat;
    ...
    invoke-virtual {v0, v1}, Lcom/jakex/makeupcore/bean/Chat;->setChatFail(Ljava/lang/Boolean;)V

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/jakex/makeupcore/bean/Chat;->setUploadState(Ljava/lang/Integer;)V

    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getContent()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/jakex/makeupcore/bean/Chat;->setContent(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getTime()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/jakex/makeupcore/bean/Chat;->setTime(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/jakex/makeupcore/bean/Chat;->getId()Ljava/lang/Float;

    move-result-object p1

    const/4 v1, 0x0

    invoke-static {p1, v1}, Lcom/jakex/makeupcore/util/bj;->a(Ljava/lang/Float;F)F
    ...
    invoke-virtual {v0, p1}, Lcom/jakex/makeupcore/bean/Chat;->setId(Ljava/lang/Float;)V
